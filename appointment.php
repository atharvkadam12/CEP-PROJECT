...
<section class="contact-section spad appointSection animate" id="Apsection" style="width:100vw;justify-content:center;background:none;padding-top:20px;padding-bottom:200px;">
        <div class="appointContainer">
            ...
            <h2 style="color:black;margin-bottom:50px;font-weight:700">BOOK APPOINTMENT</h2>
                <div class="appoint-contact">
                    <div >
                    <a
                        href="https://api.whatsapp.com/send?phone=+919960016435&text=Hi%2C%20I%20am%20interested%20in%20joining%20your%20gym"
                        target="_blank">    
                          <button class="appoint-whatsapp"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#25D366" class="bi bi-whatsapp" viewBox="0 0 16 16">
                    ...
                    <div >
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=atharv.kadam23@pccoepune.org" target="_blank">
                            <button class="appoint-mail"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#FF5722" class="bi bi-envelope" viewBox="0 0 16 16">
                    ...
                    <div>
                        <a href="tel:+919960016435">
                            <button class="appoint-phone"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#2196F3" class="bi bi-telephone" viewBox="0 0 16 16">
